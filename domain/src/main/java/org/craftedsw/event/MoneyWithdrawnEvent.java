 ...
 */
public class MoneyWithdrawnEvent extends EventBase<UserId> {
    ...
    public MoneyWithdrawnEvent(UserId aggregateId) {
        super(aggregateId);
    }
     ...
     */
    public MoneyWithdrawnEvent(long eventId, String aggregateId, int aggregateVersion, long eventTimestamp) {
