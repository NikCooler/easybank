...
public class MoneyAccount extends TableImpl<MoneyAccountRecord> {
     ...
     */
    public final TableField<MoneyAccountRecord, Currency> CURRENCY = createField(DSL.name("CURRENCY"), org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false), this, "", new org.jooq.impl.EnumConverter<java.lang.String, org.craftedsw.type.Currency>(java.lang.String.class, org.craftedsw.type.Currency.class));
