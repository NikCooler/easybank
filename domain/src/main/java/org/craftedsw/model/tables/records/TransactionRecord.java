...
public class TransactionRecord extends UpdatableRecordImpl<TransactionRecord> implements Record9<TransactionId, UserId, UserId, TransactionStatus, String, Currency, BigDecimal, String, Long> {

    private static final long serialVersionUID = 780294886;
    ...
    @Override
    public Row9<TransactionId, UserId, UserId, TransactionStatus, String, Currency, BigDecimal, String, Long> valuesRow() {
    ...
    @Override
    public TransactionRecord values(TransactionId value1, UserId value2, UserId value3, TransactionStatus value4, String value5, Currency value6, BigDecimal value7, String value8, Long value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransactionRecord(TransactionId transactionId, UserId transferredFrom, UserId transferredTo, TransactionStatus status, String type, Currency currency, BigDecimal value, String errorMessage, Long eventTimestamp) {
        super(Transaction.TRANSACTION);
